...
export default function SettingsOverviewPage() {
  return (
    <Stack gap={8}>
            ...
            <CardBody py={3} borderBottomWidth="1px">
              <VStack alignItems="flex-start">
                ...
                <HStack>
                  ...
                  <Text textStyle="sm">store.tio@tiojohnstore.com</Text>
                </HStack>
              </VStack>
            </CardBody>
            <CardFooter py={3}>
      ...
      <VStack gap={6} alignItems="flex-start">
        <Page.SectionTitle>Your account</Page.SectionTitle>
        <HStack gap={8} w="100%">
          <Card width="100%">
            <CardHeader py={3} borderBottomWidth="1px" flex={1}>
              <HStack w="100%">
            ...
            <CardBody py={3} borderBottomWidth="1px">
              <VStack alignItems="flex-start">
                <HStack>
                  ...
                  <Text textStyle="sm">Tio John</Text>
                </HStack>
                <HStack>
                  <Text textStyle="sm" color="fg.muted">
                    Email
                  </Text>
                  <Text textStyle="sm">tio.john@gmail.com</Text>
                </HStack>
              </VStack>
            </CardBody>
            <CardFooter py={3}>
